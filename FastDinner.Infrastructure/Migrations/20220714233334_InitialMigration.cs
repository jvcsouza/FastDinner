...
namespace FastDinner.Infrastructure.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"INSERT INTO RESTAURANTS (ID, NAME, ADDRESS, PHONE, EMAIL) 
                VALUES ('F2053C55-D75C-4EB7-A529-A72A1A3CC380', 'Restaurant 1', 'Address 1', '0123456789',  'teste@teste.com')");

            migrationBuilder.Sql(@"INSERT INTO EMPLOYEES (Id, Name, Email, Password, Role, Discriminator, Act, RestaurantId)
                VALUES ('99C27FD9-EBA0-46A7-845A-53B38E246A0B', 'admin', 'admin@admin.com', 'admin', 4, 'Admin', 1, 'F2053C55-D75C-4EB7-A529-A72A1A3CC380')");
        }
